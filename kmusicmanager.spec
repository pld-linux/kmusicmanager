...
Głównymi możliwościami programu KMusicManager są:
- zarządzanie kolekcjami muzycznymi w formacie MP3, Ogg-Vorbis, FLAC
- obserwacja katalogów w poszukiwaniu nowym piosenek
- edycja opisów piosenek
- tworzenie playlist metodą przeciągania myszką
